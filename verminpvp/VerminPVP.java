...
/**
 * Main plugin class for VerminPVP - A class-based PVP system
 * 
...
public class VerminPVP extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("VerminPVP is enabling...");
        ...
        getLogger().info("VerminPVP has been enabled successfully!");
    }
    
    @Override
    public void onDisable() {
        getLogger().info("VerminPVP is disabling...");
        ...
        getLogger().info("VerminPVP has been disabled successfully!");
        instance = null;
    }
    ...
    private void registerCommands() {
        ...
        getCommand("verminpvp").setExecutor(classCommand);
        getCommand("verminpvp").setTabCompleter(classCommand);
     ...
     * @return The VerminPVP plugin instance
     */
