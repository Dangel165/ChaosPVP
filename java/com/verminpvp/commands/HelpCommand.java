...
public class HelpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Send help message
        player.sendMessage("§6§l========== VerminPVP 도움말 ==========");
        player.sendMessage("");
        ...
        player.sendMessage("§a/맵지정 [맵이름] §7- 현재 위치를 맵 스폰으로 설정합니다");
        player.sendMessage("§a/맵제거 <번호> §7- 맵을 제거합니다");
        ...
        player.sendMessage("§72. §f/맵지정 §7- 일반 맵 추가 (최소 1개)");
        player.sendMessage("§73. §f/게임모드 §7- 팀전 또는 개인전 선택");
        player.sendMessage("§74. §f/게임시작 §7- 게임 시작");
        player.sendMessage("§75. §f클래스 선택 §7- 원하는 클래스 선택");
        player.sendMessage("§76. §f로비 이동 §7- 10초 대기");
        player.sendMessage("§77. §f맵 텔포 §7- 각 플레이어 랜덤 맵으로 이동");
        player.sendMessage("§78. §f10초 프리즈 §7- 이동 불가 상태");
        player.sendMessage("§79. §f게임 시작! §7- 10분 전투");
        player.sendMessage("");
