...
public class ItemProvider {
    ...
    private ItemStack createCriticalCutterSword() {
        ...
        // Add attack damage attribute (5 damage = 2.5 hearts, same as stone sword)
        meta.addAttributeModifier(
            org.bukkit.attribute.Attribute.ATTACK_DAMAGE,
            new org.bukkit.attribute.AttributeModifier(
                new NamespacedKey(plugin, "critical_cutter_damage"),
                5.0,
                org.bukkit.attribute.AttributeModifier.Operation.ADD_NUMBER,
        ...
        // Add attack speed attribute (2.2 attack speed)
        // Base attack speed is 4.0, so we add (2.2 - 4.0) = -1.8
        meta.addAttributeModifier(
